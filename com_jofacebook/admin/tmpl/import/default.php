...
Joomla.continueImport = function() {
    ...
    // do field validation
    if (error) {
        alert("<?php echo Text::_('COM_JOFACEBOOK_IMPORT_MSG_PLEASE_SELECT_ALL_COLUMNS', true); ?>");
    } else {
...
Joomla.submitbutton = function() {
    ...
    if (form.import_package.value == "") {
        alert("<?php echo Text::_('COM_JOFACEBOOK_IMPORT_MSG_PLEASE_SELECT_A_FILE', true); ?>");
    } else {
        document.getElementById('loading').style.display = 'block';
...
Joomla.submitbutton3 = function() {
    ...
    if (form.import_directory.value == ""){
        alert("<?php echo Text::_('COM_JOFACEBOOK_IMPORT_MSG_PLEASE_SELECT_A_DIRECTORY', true); ?>");
    } else {
        document.getElementById('loading').style.display = 'block';
...
Joomla.submitbutton4 = function() {
    ...
    if (form.import_url.value == "" || form.import_url.value == "http://") {
        alert("<?php echo Text::_('COM_JOFACEBOOK_IMPORT_MSG_ENTER_A_URL', true); ?>");
    } else {
        document.getElementById('loading').style.display = 'block';

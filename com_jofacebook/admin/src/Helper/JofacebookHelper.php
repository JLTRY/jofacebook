...
/-------------------------------------------------------------------------------------------------------/
    ...
    @package		JOFacebook
    @subpackage		JofacebookHelper.php
...
/------------------------------------------------------------------------------------------------------*/
namespace JLTRY\Component\Jofacebook\Administrator\Helper;

// The power autoloader for this project (JPATH_ADMINISTRATOR) area.
$power_autoloader = JPATH_ADMINISTRATOR . '/components/com_jofacebook/src/Helper/PowerloaderHelper.php';
...
/**
 * Jofacebook component helper.
 *
 * @since   3.0
 */
abstract class JofacebookHelper
{
    /**
     * Composer Switch
     *
    ...
    {
        $manifestUrl = JPATH_ADMINISTRATOR."/components/com_jofacebook/jofacebook.xml";
    ...
    public static function addSubmenu($submenu)
    {
        ...
        \JHtmlSidebar::addEntry(Text::_('COM_JOFACEBOOK_SUBMENU_DASHBOARD'), 'index.php?option=com_jofacebook&view=jofacebook', $submenu === 'jofacebook');
    }
    ...
    */
     ...
     */
    public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'jofacebook')
    {
     ...
     */
    public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'jofacebook', $unique = true)
    {
    ...
    public static function isPublished($id,$type)
    {
        ...
        $query->from('#__jofacebook_'.$type.' AS a');
     ...
     */
    public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'jofacebook', $user = 'null')
    {
    ...
    public static function getModel(string $type, string $prefix = 'Administrator',
        string $component = 'jofacebook', array $config = [])
    {
    ...
    public static function setAsset($id, $table, $inherit = true)
    {
        ...
        $parent->loadByName('com_jofacebook');

        $parentId = $parent->id;
        $name     = 'com_jofacebook.'.$table.'.'.$id;
        $title    = '';
        ...
        else
        {
            ...
            $rules = self::getDefaultAssetRules('com_jofacebook', $table, $inherit);
            ...
            else
            {
                ...
                return Factory::getDbo()->updateObject('#__jofacebook_'.$table, $object, 'id');
            }
        }
        return false;
    }

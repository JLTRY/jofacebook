...
/-------------------------------------------------------------------------------------------------------/
	...
	@package		JOFacebook
	@subpackage		FacebookpostController.php
...
/**
 * Jofacebook Facebookpost Base Controller
 *
 * @since  1.6
 */
class FacebookpostController extends BaseController
{
	/**
	 ...
	 * @since  1.6
	 */
	protected $context = 'facebookpost';
	 ...
	 * @since  1.6
	 */
	protected $view_item = 'facebookpost';

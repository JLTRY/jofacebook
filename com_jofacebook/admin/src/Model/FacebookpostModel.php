...
/-------------------------------------------------------------------------------------------------------/
    ...
    @package		JOFacebook
    @subpackage		FacebookpostModel.php
...
/**
 * Jofacebook Facebookpost Item Model
 *
 * @since  1.6
 */
class FacebookpostModel extends ItemModel
{
    /**
     ...
     * @since   1.6
     */
    protected $_context = 'com_jofacebook.facebookpost';
    ...
    protected array $styles = [
        ...
        'administrator/components/com_jofacebook/assets/css/facebookpost.css'
    ];
    ...
    protected function populateState()
    {
        ...
        $this->setState('facebookpost.id', $id);
    ...
    public function getItem($pk = null)
    {
        ...
        if (!$this->user->authorise('facebookpost.access', 'com_jofacebook'))
        {
        ...
        $pk = (!empty($pk)) ? $pk : (int) $this->getState('facebookpost.id');

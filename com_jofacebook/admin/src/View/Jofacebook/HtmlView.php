...
/------------------------------------------------------------------------------------------------------*/
namespace JLTRY\Component\Jofacebook\Administrator\View\Jofacebook;
...
class HtmlView extends BaseHtmlView
{
    ...
    function display($tpl = null): void
    {
        ...
        $this->contributors   = JofacebookHelper::getContributors();

        // get the manifest details of the component
        $this->manifest = JofacebookHelper::manifest();
    ...
    {
        $canDo = JofacebookHelper::getActions('jofacebook');
        ToolbarHelper::title(Text::_('COM_JOFACEBOOK_DASHBOARD'), 'grid-2');

        // set help url for this view if found
        $this->help_url = JofacebookHelper::getHelpUrl('jofacebook');
    ...
    {
        // set page title
        $this->getDocument()->setTitle(Text::_('COM_JOFACEBOOK_DASHBOARD'));
